    ...
    <div id="footer">
      <div className="row">
        <div className="col" id="footer-col">
          ...
          <h3 className="footer-contact" id="footer-insta"><img src="https://res.cloudinary.com/dawteptkh/image/upload/v1706714461/instagram_vrh3xy.png" className="footer-img" alt="" width="24px"/>@radiantlighthairdesign</h3>
        </div>
